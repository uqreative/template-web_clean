			...
			<th scope="row">첨부파일</th>
				...
				<?
					for($i = 1; $i <= $board[file_count]; $i++) {
							...
							echo "<div><div class='designFile'><em>파일첨부</em><input type='text' readonly='readonly' value=''/><input type='file' name='file_$i' id='file_$i'/><label for='file_$i' class='btn'> $del_</label></div>$del_2 </div>";
					 }
				?>
