...
function list_ajax(board, keyword, search_key, start, cate){
	...
	$.ajax({
		type : "POST",
		url : "/ko_admin/board/skin/ajax_area/ajax_list.php",
		data : {
			board_id : board,
			keyword : keyword,
...
function view_ajax(board, keyword, search_key, start, cate, no){
	...
	$.ajax({
		type : "POST",
		url : "/ko_admin/board/skin/ajax_area/ajax_view.php",
		data : {
			board_id : board,
			keyword : keyword,
			search_key : search_key,
...
function do_auth(mode, board, keyword, search_key, start, cate, no, passwd, return_mode){
	...
	var url_ = "/ko_admin/board/skin/ajax_area/ajax_auth_check.php";
...
function do_Process(mode, board, keyword, search_key, start, cate, no, passwd, ref_no){
	...
	if(mode == "write"){
		...
		var url_ = "/ko_admin/board/skin/ajax_area/ajax_form.php";
		...
		var url_ = "/ko_admin/board/skin/ajax_area/ajax_view.php";

	} else if(mode == "delete"){

		var url_ = "/ko_admin/board/skin/ajax_area/ajax_proc.php";
		...
		var url_ = "/ko_admin/board/skin/ajax_area/ajax_check.php";
		...
		var url_ = "/ko_admin/board/skin/ajax_area/ajax_list.php";
