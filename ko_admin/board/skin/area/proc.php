...
$comm_comments = $_GET[comm_comments];
	...
	/*mysql_query("INSERT INTO $board_id VALUES ('', '$depth', '$ref_no', '$check_[ref_group]', '$_SESSION[member_id]', '$_SESSION[CI]', '$_SESSION[DI]', '$name', '$password', '$phone','$email', '$zip', '$address1', '$address2', '$category', '$title', '$comments_type','$tag_type
	,'$comments', '$etc', '$notice', '$secret', '$file_type', '$file_1', '$file_2', '$file_3', '$file_4', '$file_5', '$file_6', '$file_7', '$file_8', '$file_9', '$file_10', '$reg_date', '$ip', '$reply_state', '$reply_id', '$reply_name', '$reply_phone', '$reply_email', '$reply_comments', '$reply_ip', '$reply_date', '$reply_file_1', '$reply_file_2', '$reply_file_3', '$reply_file_4', '$reply_file_5', '$view_count', '$hidden', '$link','','')");
	*/
	...
	*/
	...
	alert("등록되었습니다.");
	url($return_url[0]."?board_id=$board_id&amp;mode=list");
