...
if($mode == "modify_proc"){
	...
	*/
	...
	mysqli_query($dbp, "INSERT INTO $program_table VALUES ('', '$title', '$contents', '$title_img', '$link_url','$link_type', '$start_date', '$end_date', '$state', '$width', '$height','$position_width', '$position_height', '$reg_date')");
